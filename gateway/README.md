...
1. Extract **wayfarer-pc-companion-1.4.2.zip** into a folder on your PC.
...
Use the [Wayfarer mini-app download](https://github.com/Darker117/wayfarer-layla/releases/tag/v1.4.2) on the phone. The PC companion stays on the PC.
